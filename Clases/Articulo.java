...
public class Articulo extends javax.swing.JFrame {
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
         if (jTextField2.getText().isEmpty() || jTextField3.getText().isEmpty() || jTextField4.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Complete todos los campos.", "Información", JOptionPane.INFORMATION_MESSAGE);
            jTextField2.setText("");
            jTextField3.setText("");
            jTextField4.setText("");
            ...
            try {
                res = Conexiones.Conexion.Consulta("SELECT COUNT(Nombre) FROM Empleados WHERE Nombre='" + jTextField2.getText() + "'");
                while (res.next()) {
                    cont = res.getInt(1);
                }
                if (cont >= 1) {
                    JOptionPane.showMessageDialog(this, "Este elemento ya existe.", "Información", JOptionPane.INFORMATION_MESSAGE);
                } else {
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        ...
        int opc = JOptionPane.showConfirmDialog(this, "¿Estás seguro de que deseas eliminar este registro?", "Confirmación", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
    ...
    private void jMenuItem6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem6ActionPerformed
        try {
        PreparedStatement pps = Conexiones.Conexion.getConexion().prepareStatement(
            "UPDATE Empleados SET Nombre=?, Apellido=?, Cargo=?, Salario=?, Fecha_Contratación=?, Correo_Electronico=?, Teléfono=? WHERE id_empleado=?");
        pps.setString(1, jTextField2.getText());
        pps.setString(2, jTextField3.getText());
        pps.setString(3, jTextField4.getText());
        pps.setString(4, jTextField5.getText());
        pps.setString(5, jTextField6.getText());
        pps.setString(6, jTextField7.getText());
        pps.setString(7, jTextField8.getText());
        pps.setString(8, jTextField1.getText());
        ...
        // Establecer el foco en jTextField1
        jTextField1.requestFocus();
    } catch (SQLException e) {
